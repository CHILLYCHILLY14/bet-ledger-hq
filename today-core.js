...
(function(root,factory){
  ...
  function accuracy(key,bundle){
    ...
    if(key==="mlb"){
      ...
      return {key,label:"MLB game predictions",scope:"Recorded pregame forecasts · "+(bundle.meta?.settings?.season||"season not supplied"),
        ...
        notes:["Model and market comparisons use the same matched games.","Game-winner accuracy is not betting ROI."]};
    }
